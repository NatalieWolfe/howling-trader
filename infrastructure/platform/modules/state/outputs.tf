output "s3_access_key" {
  value       = ovh_cloud_project_user_s3_credential.tofu_state_s3_creds.access_key_id
  description = "The S3 Access Key for remote state"
}

output "s3_secret_key" {
  value       = ovh_cloud_project_user_s3_credential.tofu_state_s3_creds.secret_access_key
  sensitive   = true
